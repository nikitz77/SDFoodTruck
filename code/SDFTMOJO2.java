...
// Class Definition
public class SDFTMOJO2 extends JFrame {
	...
	String s1 = "C:\\Users\\Karenina\\Desktop\\FoodTruck\\shap\\mySD.shp";
	String s2 = "C:\\Users\\Karenina\\Desktop\\FoodTruck\\shap\\Top3.shp";
	String s3 = "C:\\Users\\Karenina\\Desktop\\FoodTruck\\shap\\AllDays.shp";
	String datapathname = "";
	String legendname = "";
	...
	//ImageIcons
	ImageIcon clico = new ImageIcon("C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\clico.jpg");
	ImageIcon tvico = new ImageIcon("C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\tableview.jpg") ;
	ImageIcon dslico = new ImageIcon("C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\demote.jpg") ;
	ImageIcon fmpico = new ImageIcon("C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\print.jpg") ;
	ImageIcon alico = new ImageIcon("C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\addtheme.jpg") ;
	ImageIcon rlico = new ImageIcon("C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\delete.jpg") ;
	ImageIcon leico = new ImageIcon("C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\properties.jpg") ;
	ImageIcon helpico = new ImageIcon("C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\help.png");
	static ImageIcon pslico = new ImageIcon("C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\promote.jpg") ;

	//Connect ImageIcons to JMenuIcons now
	...
	JButton prtjb = new JButton(new ImageIcon("C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\print.jpg"));
	JButton addlyrjb = new JButton(new ImageIcon("C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\addtheme.jpg"));
	JButton ptrjb = new JButton(new ImageIcon("C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\pointer.jpg"));
	JButton distjb = new JButton(new ImageIcon("C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\measure_1.gif"));
	JButton XYjb = new JButton("XY");
	JButton hotjb = new JButton(new ImageIcon("C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\fork16.png"));
	JButton helptooljb = new JButton(new ImageIcon("C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\help2.png"));

	//hotlink
	Toolkit tk = Toolkit.getDefaultToolkit();
	Image bolt = tk.getImage("C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\hotlink.png");
	java.awt.Cursor boltCursor = tk.createCustomCursor(bolt,
										new java.awt.Point(6,30),"bolt");

	//PickAdapter for hotlink
	MyPickAdapter picklis = new MyPickAdapter();
	Identify hotlink = new Identify();

	
	// CLASS: MyPickAdapter - hotlink tool listener implemented by Identity class.
	class MyPickAdapter implements PickListener {
		...
		// FUNCTION: beginPick() - This code runs when the user clicks the mouse when hotlink
		//              tool is enabled.
		...
		// FUNCTION: foundData() - This code runs when the user has clicked near a feature on
		//              the active layer.
		...
		// FUNCTION: endPick() = This code runs after the user has clicked.  It resets the
	...
	// FUNCTION: SDFTMOJO2() -  Main Application Constructor
	public SDFTMOJO2() {

		// Top level variables...
		super("San Diego Food Trucks");
		helpToolOn = false ;
			...
			public void actionPerformed(ActionEvent ae) {
				...
				if (source instanceof JMenuItem) {
					...
					if(arg == "Add Layer") {
						...
						ab.setProductName("SDFTMOJO2");
						ab.setProductVersion("2.0");
						ab.setVisible(true) ;
					} else if (arg == "Contact Us"){
						try {
							String s = "\n\nInquiries should be addresses to: " ;
							s = s + "SDFTMOJO2@rohan.sdsu.edu." ;
	    ...
	    RasterMarkerSymbol top3 = new RasterMarkerSymbol() ;
	    top3.setImageString("C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\tinyFTblk.jpg");
	    top3.setSizeX(30);
	    top3.setSizeY(15);
		bsr0.setSymbol(top3) ;
	    ...
	    RasterMarkerSymbol ad = new RasterMarkerSymbol() ;
	    ad.setImageString("C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\tinyFTya.png");
	    ad.setSizeX(30);
	    ad.setSizeY(15);
		bsr1.setSymbol(ad) ;
	...
	// FUNCTION: addShapefileToMap() -  Adds a shp file to the map
	...
	// FUNCTION: enableDisableButtons() -  Depending on what's happening in the application these
	...
	// FUNCTION: setuphelpText() -  Just a helper function to handle strings and help for the
	//              user
	private void setuphelpText() {
	    ...
	    + "are separate Help Topics.  This line is e...x...t...e...n...d...e...d"
	...
	public static void main(String[] args) {
		...
		SDFTMOJO2 qstart = new SDFTMOJO2();
...
// CLASS: AddLyrDialog -  This class handles when the user selects the AddLayer option
...
class AddLyrDialog extends JDialog {
			...
			public void actionPerformed(ActionEvent ae) {
				...
				if (source == cancel) {
					...
					try {
						...
						map.redraw();
						if (SDFTMOJO2.stb.getSelectedLayers() != null) {
							SDFTMOJO2.pitem.setEnabled(true);
						}
					} catch(IOException e){}
				}
			}
	...
	// FUNCTION: setMap() - This function will set the map to the map passed in.
...
// CLASS: XYfeatureLayer - This is the nuts and bolts class for the create feature layer
...
class XYfeatureLayer extends BaseFeatureLayer {
	...
	// FUNCTION: createFeaturesAndFields() - This creates the main data structure used by the XYTool to
	...
	// FUNCTION: createDbfFields() - This setups the attribute table, names the columns and
	...
	private void createDbfFields() {
			...
			fields.addField(new BaseField("Hours",java.sql.Types.VARCHAR,32,0));
			fields.addField(new BaseField("URL",java.sql.Types.VARCHAR,128,0));
			fields.addField(new BaseField("Rating",java.sql.Types.VARCHAR,32,0));
			fields.addField(new BaseField("comments",java.sql.Types.VARCHAR,32,0));
		}

	// FUNCTION: BaseFeatureClass() - This function returns the BaseFeature class.
	...
	// FUNCTION: XYLayerCapabilities - This function sets some properties of the new feature layer
...
// CLASS: AttrTab - This class displays the attribute table for the active layer
class AttrTab extends JDialog {
	JPanel panel1 = new JPanel();
	com.esri.mo2.map.dpy.Layer layer = SDFTMOJO2.layer4;
	JTable jtable = new JTable(new MyTableModel());
	JScrollPane scroll = new JScrollPane(jtable);

	// FUNCTION: AttrTab()- Class constructor
...
//CLASS: MyTableModel - This class creates the attribute table
class MyTableModel extends AbstractTableModel {
	...
	// FUNCTION: getColumnCount() - Returns the # of columns
	public int getColumnCount() {
		return fclass.getFields().getNumFields();
	}

	// FUNCTION: getRowCount() - Returns the # of rows
	public int getRowCount() {
		return data.size();
	}

	// FUNCTION: getColumnName() - Returns the name of column
	public String getColumnName(int colIndx) {
		return columnNames[colIndx];
	}

	// FUNCTION: getValueAt() - Returns the value in the cell in the table
...
//CLASS: CreateShapeDialog - This class writes the new shapefile to disk
			...
			if (o == nameField) {
				...
				try {
					path = ((ShapefileFolder)
							(SDFTMOJO2.layer4.getLayerSource())).getPath();
				} catch ( Exception e ) {
					path = "C:\\Users\\Karenina\\Desktop\\FoodTruck\\shap" ;
				}
...
//CLASS: Arrow - This class handles the mouse cursor behavior.
class Arrow extends Tool {

	// FUNCTION: Arrow() =Class constructor
	public Arrow() {
		SDFTMOJO2.milesLabel.setText("DIST   0 mi   ");
		SDFTMOJO2.kmLabel.setText("   0 km    ");
		SDFTMOJO2.map.repaint();
		SDFTMOJO2.helpToolOn = false ;
	}
}


//CLASS: Flash - When a new layer is added this class will flash the new layer
...
class Flash extends Thread {
	...
	// FUNCTION: run() - This is the function that will be executed when the child
	//              thread is invoked.
	public void run() {
		for (int i=0;i<12;i++) {
			try {
...
//CLASS: DistanceTool - A class to help calculate as the crow flies distance
...
class DistanceTool extends DragTool  {
	...
	// FUNCTION: mousePressed() -Collects the starting point for the user.
	public void mousePressed(MouseEvent me) {
		startx = me.getX(); starty = me.getY();
		initPoint = SDFTMOJO2.map.transformPixelToWorld(me.getX(),me.getY());
	}

	// FUNCTION: mouseReleased() -Collects the end point and calculates as the crow flies
	//              distance.
	public void mouseReleased(MouseEvent me) {
		endx = me.getX(); endy = me.getY();
		endPoint = SDFTMOJO2.map.transformPixelToWorld(me.getX(),me.getY());
		...
		SDFTMOJO2.milesLabel.setText("DIST: " +
									 new Float((float)distance).toString()
									 + " mi  ");
		SDFTMOJO2.kmLabel.setText(new Float((float)(distance*1.6093)).toString()
								  + " km");

		if (SDFTMOJO2.acetLayer != null) {
			SDFTMOJO2.map.remove(SDFTMOJO2.acetLayer);
		}

		SDFTMOJO2.acetLayer = new AcetateLayer() {
		...
		SDFTMOJO2.map.add(SDFTMOJO2.acetLayer);
		SDFTMOJO2.map.redraw();
	}

	// FUNCTION: cancel() - DESCRIPTION: Null function to handle cancel event
	public void cancel() {};
}


//CLASS: HotPick -Displays a dialog window with attribute data information as
...
class HotPick extends JDialog {
	...
	String[][] b = new String[][] {
			{ "C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\MGfood.jpg",
			  "C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\MGmenu.jpg",
			  "C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\MGtruck.jpg" },
			{ "C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\SuperQlogo.jpg"},
			{ "C:\\Users\\Karenina\\Desktop\\FoodTruck\\imgs\\DeviliciousCollage.jpg"}
		} ;

	// FUNCTION: HotPick()- Class constructor
	public HotPick(int id, Row row, int activeLayerIndex, Map map)
		...
		if ( new String("Food Trucks").equals(curLayerName) ) {
		...
		jblis = new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				// Default to windows...
				String b = "C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome";
				b = b + " " + url ;
...
//CLASS: HelpDialog - A Help Menu function to display a new window and display
//             helpful text to the user to help show them how to use the app.
class HelpDialog extends JDialog {
	JTextArea ha ;

	// FUNCTION: HelpDialog() - Class constructor
